 ...
 * the Oracle Content SDK client.  This callback function is called just before the REST request
...
export default function getClient() {
  ...
  // add the 'beforeSend' callback so the authorization header can be added to the Oracle Content
  // requests
